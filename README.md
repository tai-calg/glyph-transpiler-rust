...
完全な仕様、保証範囲、Host責任、コード例は[`CONTRACTS.md`](CONTRACTS.md)を参照してください。全層を接続した受入例は[`examples/acceptance/glyph04_system.glyph`](examples/acceptance/glyph04_system.glyph)です。
