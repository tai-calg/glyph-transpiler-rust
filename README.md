...
詳細: [`PREPROCESSOR.md`](PREPROCESSOR.md)
...
詳細: [`ACCEPTANCE.md`](ACCEPTANCE.md)
...
- [`PREPROCESSOR.md`](PREPROCESSOR.md) — rawマクロ
- [`TEMPORAL.md`](TEMPORAL.md) — 時相制約
- [`ALGORITHM_IR.md`](ALGORITHM_IR.md) — Source-level Logic IR
- [`COMPILATION_PIPELINE.md`](COMPILATION_PIPELINE.md) — 正本コンパイルAPIとIR schema
- [`RUST_TODO.md`](RUST_TODO.md) — `~`と`manual.rs`
- [`ACCEPTANCE.md`](ACCEPTANCE.md) — v0.1 acceptance campaign
