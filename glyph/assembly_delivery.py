...
def install_machine_assembly_delivery() -> None:
    ...
    Assembly model. CompilationPipeline alone receives analysis-safe blocked Rust
    artifacts so Studio and diagrams remain available.
    """
    ...
    artifacts_module.build_rust_artifacts = build_rust_artifacts
    ...
    # while a direct Rust generation request fails before emitting a file.
