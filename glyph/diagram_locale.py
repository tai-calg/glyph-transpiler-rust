...
function apply(){
 ...
 const title=document.querySelector(".view-controls h2");if(title){const value=document.querySelector('.tab.active')?.dataset.tab==="state"?t("stateTitle"):t("ioTitle");if(title.textContent!==value)title.textContent=value}
 const note=document.querySelector(".view-controls .note");if(note){const value=document.querySelector('.tab.active')?.dataset.tab==="state"?t("stateNote"):t("ioNote");if(note.textContent!==value)note.textContent=value}
