...
const control={marker:MARKER,version:2,ownsScheduling:false,managedScripts:managed};
...
def enhance_transition_layout_transaction_bootstrap_html(html: str) -> str:
    """Install one layout owner before legacy transition presentation layers load."""
