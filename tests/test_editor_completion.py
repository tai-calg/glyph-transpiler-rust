...
class EditorCompletionTests(unittest.TestCase):
    ...
    def test_lexical_worker_only_promotes_real_top_level_direct_symbols(self) -> None:
        ...
        self.assertIn('const systemRe=/^system', LEXICAL_WORKER_JS)
        self.assertIn('const machineRe=/^machine', LEXICAL_WORKER_JS)
        self.assertNotIn('const productRe=/^[ \\t]*', LEXICAL_WORKER_JS)
        self.assertNotIn('const functionRe=/^[ \\t]*', LEXICAL_WORKER_JS)
